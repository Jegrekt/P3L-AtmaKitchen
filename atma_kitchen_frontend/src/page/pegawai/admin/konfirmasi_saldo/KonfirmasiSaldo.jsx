...
import {
  getListPendingKonfirmasiSaldo,
  konfirmasiSaldo,
} from "../../../../api/ApiKonfirmSaldo";
...
import KonfirmasiSaldowRow from "./KonfirmasiSaldowRow";
function KonfirmasiSaldo() {
  ...
  const fetchData = (page, search) => {
    setIsLoading(true);
    getListPendingKonfirmasiSaldo(page, search)
      .then((res) => {
        setData(res.data);
        console.log(res);
  ...
  return (
    <>
      ...
      >
        <DialogHeader>Konfirmasi Penarikan Saldo</DialogHeader>
...
export default KonfirmasiSaldo;
