...
import { usePengirimanAdmin } from "./usePengirimanAdmin";
import PengirimanAdminCard from "./PengirimanAdminCard";
...
function PengirimanAdminView() {
  const handleOpen = () => setOpen(!open);
  const { data, isLoading, handleInputJarak, isProcessing } =
    usePengirimanAdmin(handleOpen);
  ...
  return (
    <div className="w-full">
      <h1 className="text-2xl font-semibold text-gray-800 mb-8">Pengiriman</h1>
      <div className="p-4 flex items-center justify-between gap-4 bg-green-50 rounded-lg text-green-700 mb-4">
        <BsInfoCircle />
        <div className="flex-1">
          Data dibawah merupakan daftar pesanan yang perlu diinput jaraknya
        </div>
      </div>
      ...
      >
        <DialogHeader>Input Jarak</DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            onClick={() => {
              handleInputJarak(selectedData.id_alamat, jarak);
            }}
          >
            <span>Confirm</span>
          </Button>
...
export default PengirimanAdminView;
