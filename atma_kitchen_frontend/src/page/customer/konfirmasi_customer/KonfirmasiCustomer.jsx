...
import {
  getListKonfirmasiCustomer,
  KonfirmasiCustomerLast,
} from "../../../api/ApiKonfirmasiCustomer";
...
import KonfirmasiCustomerRow from "./KonfirmasiCustomerRow";
function KonfirmasiCustomer() {
  ...
  const fetchData = (page, search) => {
    setIsLoading(true);
    getListKonfirmasiCustomer(page, search)
      .then((res) => {
        setData(res.data);
        console.log(res);
...
export default KonfirmasiCustomer;
