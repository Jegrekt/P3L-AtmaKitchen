...
mixin _$LogoutEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int id) logout,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function()? started,
    TResult? Function(int id)? logout,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$LogoutImpl implements _Logout {
  const _$LogoutImpl({required this.id});
  ...
  @override
  String toString() {
    return 'LogoutEvent.logout(id: $id)';
  }
...
abstract class _Logout implements LogoutEvent {
  const factory _Logout({required final int id}) = _$LogoutImpl;
